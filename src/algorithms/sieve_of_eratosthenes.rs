...
impl SieveOfEratosthenes {
    ...
    pub fn integer_factorization(&self, mut n: usize) -> HashMap<usize, usize> {
    ...
    pub fn gen_divisors(&self, n: usize) -> HashSet<usize> {
        ...
        res.into_iter().collect::<HashSet<usize>>()
    }
}
...
mod tests {
    ...
    fn test() {
        ...
        assert_eq!(HashSet::from([1, 5, 11, 55]), sieve.gen_divisors(55));
    }
}
